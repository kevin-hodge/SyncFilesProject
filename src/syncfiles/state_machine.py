...
from typing import Dict, Callable, List, Any, Optional, cast
...
class StateMachine:
    ...
    def new_state(self, state_name: str, state_function: Callable[[Any], Any],
    ...
    def run(self, state_info: Any) -> None:
        ...
        """
        try:
            state_function: Callable[[Any], Any] = self.state_functions[
